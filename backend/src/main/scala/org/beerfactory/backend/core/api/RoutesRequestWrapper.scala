 ...
 *********************************************************************************
 */
package org.beerfactory.backend.core.api
...
import org.beerfactory.backend.core.api.`X-Content-Type-Options`.`nosniff`
import org.beerfactory.backend.core.api.`X-Frame-Options`.`DENY`
import org.beerfactory.backend.core.api.`X-XSS-Protection`.`1; mode=block`
